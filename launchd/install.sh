...
install_plist "$SCRIPT_DIR/com.football-predictor.warmup.plist"
install_plist "$SCRIPT_DIR/com.football-predictor.watchdog.plist"
...
echo "  • com.football-predictor.results-poll — result filler every 2h"
echo "  • com.football-predictor.warmup    — analysis-cache warm-up every 50min"
echo "  • com.football-predictor.watchdog  — uptime probe + auto-recover every 5min"
echo ""
echo "Logs: $LOG_DIR/"
