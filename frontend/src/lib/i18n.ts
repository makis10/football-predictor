...
const en: Table = {
  ...
  "stats.discrimination.none": "This forecast carries almost no information: AUC {auc} against 0.50 for a coin, and {share}% of every value it produces falls inside a {width}-point band. A flat forecast can still plot perfectly on the diagonal below \u2014 calibration says the numbers are honest, not that they tell matches apart.",
...
const el: Table = {
  ...
  "stats.discrimination.none": "Αυτή η πρόβλεψη δεν έχει σχεδόν καμία πληροφορία: AUC {auc} έναντι 0,50 του κέρματος, και το {share}% όλων των τιμών της πέφτει μέσα σε ζώνη {width} μονάδων. Μια επίπεδη πρόβλεψη μπορεί να ζωγραφίζει τέλεια πάνω στη διαγώνιο παρακάτω — η βαθμονόμηση λέει ότι τα νούμερα είναι έντιμα, όχι ότι ξεχωρίζουν αγώνες.",
