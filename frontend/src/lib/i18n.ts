...
const en: Table = {
  ...
  "pred.range": "range {lo}–{hi}%",
  "pred.bandLegend": "The hatched band is how far off we would not be surprised to be — wider means less certain.",
...
const el: Table = {
  ...
  "pred.range": "εύρος {lo}–{hi}%",
  "pred.bandLegend": "Η ριγέ ζώνη είναι πόσο δεν θα μας εξέπληττε να πέσουμε έξω — όσο πιο φαρδιά, τόσο λιγότερη βεβαιότητα.",
